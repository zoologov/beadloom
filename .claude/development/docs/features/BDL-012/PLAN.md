...
### BEAD-07: Integration test + dogfood on core-monolith & secondary-system (P0)
- **Issue:** All
- **Files:** `tests/test_integration_onboarding.py`, CHANGELOG, UX-Issues
- **Task:** Run `beadloom init --bootstrap` on core-monolith and secondary-system. Verify doctor 0, lint 0, symbols > 0, preset correct. Update CHANGELOG, close UX issues.
