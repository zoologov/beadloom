...
Fix 10 UX issues from dogfooding `beadloom init --bootstrap` on core-monolith (Django+Vue, 44 nodes) and secondary-system (React Native+TS, 6 nodes). After fixes: `doctor` 0 warnings, `lint` 0 false positives, skeletons contain real data.
