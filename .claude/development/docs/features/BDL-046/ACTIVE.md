...
| beadloom-ivts.4 | dev (RU locale data) | ✓ done |
| beadloom-ivts.5 | dev (config.mjs locales) | ✓ done |
| beadloom-ivts.6 | test | ✓ done |
| beadloom-ivts.7 | review | ✓ done |
| beadloom-ivts.8 | dogfood (G6) | ✓ done |
| beadloom-ivts.9 | tech-writer | ✓ done |
