...
- **Current bead:** `beadloom-0mdo.62` closed S5's fix wave second bead — the seven pure cores
  declared nowhere. All seven stay declared, measured rather than projected, and the mutation
  floor and timeout were re-derived at the new scope. Before it, `beadloom-0mdo.53` closed S5's
  third wave — BDL-UX #171 and #165, the bead-creation path. Before it, `beadloom-0mdo.51` derived the `bd` call-site population and
