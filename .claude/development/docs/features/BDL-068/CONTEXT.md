...
- **Current bead:** `beadloom-0mdo.58` derived S5's axes before any S5 dev work, which is the
  RFC's own per-slice rule and the thing S4 skipped. Fourteen rows and a fourth derivation
  block are in the RFC, and every S5 bead's `refs:` is regenerated from them. The slice's six
  beads are `.39` (merge-slot, BDL-UX #237 and #194), `.51` (the derived `bd` call-site
  population, which blocks `.52`, `.53` and `.54`), `.52` (#187, #97), `.53` (#171, #165),
  `.54` (#207, #210) and `beadloom-l2f2` (#164).
