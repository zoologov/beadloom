...
- **Phase:** Development — S5 is complete on the branch; S6 is next and runs in full.
- **Current bead:** none. `beadloom-0mdo.57` closed S5's documentation pass and `.13`, the
  slice bead, closes with it. Before it, `.62` and `.61` closed the two fix beads S5's review
...
- **Next:** S6 (`beadloom-0mdo.14`), fourteen beads plus test, review and tech-writer. The
