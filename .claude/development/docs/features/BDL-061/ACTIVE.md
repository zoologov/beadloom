...
| .79, .81–.82 | Pending | S6 follow-ups: reviewer isolation (#155 C), the committed-scope comparison (#118 remainder), and the hook's mypy leg checking a surface the project never declared typed |
