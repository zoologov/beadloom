...
| .63 | in progress | Filed by `.14`: a feature reclassified as a component leaves the population with nothing reported. Two options priced in the bead |
...
| .85 | in progress | Filed in `.24`: the per-pair attestation gap `.23` named as n5 |
