...
tags:
  ui-layer: [app-tabs, app-auth, app-messaging]
  feature-layer: [map, calendar, profile, messaging-ui]
  shared-layer: [hooks, theme, ui, navigation]
  service-layer: [maps-service, routing-service]
  native-layer: [routing-native, messaging-native]
