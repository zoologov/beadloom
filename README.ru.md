...
- **MCP-сервер** — 13 инструментов для AI-агентов, включая запись, поиск, анализ влияния, diff и линтинг
  ...
  domains/
    ...
    infrastructure/
      ...
      features/
        ...
        watcher/SPEC.md
  services/
    cli.md                                         # 22 CLI-команд
    mcp.md                                         # 13 MCP-инструментов
    tui.md                                         # TUI-дашборд
```
...
BFS depth=2 от узла `why` обходит: `why` → `context-oracle` (родительский домен) → соседние фичи (`search`, `cache`), сервисы (`cli`, `mcp-server`), кросс-доменные зависимости (`infrastructure`, `graph`) — 10 нод, 12 рёбер.
...
| **Сервисы** | |
| [CLI Reference](docs/services/cli.md) | Все 22 CLI-команды |
| [MCP Server](docs/services/mcp.md) | Все 13 MCP-инструментов для AI-агентов |
