...
Полный справочник — **[docs/services/cli.md](docs/services/cli.md)**: там все команды со всеми флагами, включая `guard`, `waves`, `review-brief`, `bd-calls`, `rooms`, `mutation`, `docs spaces`, `snapshot`, `status --debt-report` и настройку хуков через `install-hooks`.
