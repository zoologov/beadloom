...
- Each rule must have exactly one of: `deny`, `require`, `forbid_cycles`, `forbid_import`, `forbid`, `layers`, `check`, `unregistered_feature_candidate`, `module_coverage`, or `scenario_coverage` (ten rule types)
