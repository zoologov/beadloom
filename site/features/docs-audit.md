...
Zero-config meta-doc staleness detection via keyword-proximity matching

**Source:** `src/beadloom/doc_sync/audit.py`
...
- [domains/doc-sync/features/docs-audit/SPEC.md](/docs/domains/doc-sync/features/docs-audit/SPEC.md)
