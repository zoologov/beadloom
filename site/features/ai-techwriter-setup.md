...
`setup-ai-techwriter` — scaffold the packaged AI tech-writer harness (CI workflow + recipe + guide) into any repo; no vendoring
...
- [domains/onboarding/features/ai-techwriter-setup/SPEC.md](/docs/domains/onboarding/features/ai-techwriter-setup/SPEC.md)
