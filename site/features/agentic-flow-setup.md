...
`setup-agentic-flow` — scaffold Beadloom's proven multi-agent dev flow (agents/commands templates, vendored 1:1 + drift-guard) into any repo
...
- [domains/onboarding/features/agentic-flow-setup/SPEC.md](/docs/domains/onboarding/features/agentic-flow-setup/SPEC.md)
