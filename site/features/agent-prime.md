...
Cross-IDE context injection via prime CLI/MCP + AGENTS.md + IDE adapters
...
- [domains/onboarding/features/agent-prime/SPEC.md](/docs/domains/onboarding/features/agent-prime/SPEC.md)
