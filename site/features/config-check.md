...
AgentConfigAsCode — drift detection (and --fix) for generated agent-config artifacts (AGENTS.md, CLAUDE.md auto-blocks, IDE adapters)
...
- [domains/onboarding/features/config-check/SPEC.md](/docs/domains/onboarding/features/config-check/SPEC.md)
