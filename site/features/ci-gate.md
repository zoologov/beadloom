...
Unified CI gate (`beadloom ci`) — one convergence point composing reindex/lint/sync-check/config-check/doctor/federate into a single verdict
...
- [domains/application/features/ci-gate/SPEC.md](/docs/domains/application/features/ci-gate/SPEC.md)
