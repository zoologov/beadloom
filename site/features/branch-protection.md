...
`setup-branch-protection` — idempotent main branch-protection (PR-required + ci.yml required status checks)
...
- [domains/onboarding/features/branch-protection/SPEC.md](/docs/domains/onboarding/features/branch-protection/SPEC.md)
