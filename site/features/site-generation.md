...
`docs site` — generate the VitePress content tree from the indexed graph (About/architecture/per-node pages, dashboard, landscape, nav, mermaid guard)

**Source:** `src/beadloom/application/site.py`
...
- [domains/application/features/site-generation/SPEC.md](/docs/domains/application/features/site-generation/SPEC.md)
