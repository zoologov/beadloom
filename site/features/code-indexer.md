...
Tree-sitter code symbol indexer — parses src into symbols + extracts beadloom annotations
...
- [domains/context-oracle/features/code-indexer/SPEC.md](/docs/domains/context-oracle/features/code-indexer/SPEC.md)
