...
Doc-code sync engine — symbols_hash freshness state, stale detection, mark-synced baselining
...
- [domains/doc-sync/features/sync-check/SPEC.md](/docs/domains/doc-sync/features/sync-check/SPEC.md)
