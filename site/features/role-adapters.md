...
generate_adapters — writes per-tool role adapter sets (.claude/agents/*, .cursor/agents/* + Cursor orchestrator) from composed roles; the drift-guard's single writer
...
- [domains/onboarding/features/role-adapters/SPEC.md](/docs/domains/onboarding/features/role-adapters/SPEC.md)
