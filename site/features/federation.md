...
Cross-repo node identity (@repo:ref) and deterministic satellite export

**Source:** `src/beadloom/graph/federation.py`
...
- [domains/graph/features/federation/SPEC.md](/docs/domains/graph/features/federation/SPEC.md)
