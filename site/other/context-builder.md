...
Context bundle builder — BFS subgraph traversal + bundle assembly for ctx/prime
...
- [domains/context-oracle/components/context-builder/DOC.md](/docs/domains/context-oracle/components/context-builder/DOC.md)
