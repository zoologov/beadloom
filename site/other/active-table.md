...
Shared ACTIVE.md bead-status table parser/updater + reconcile-from-bd core (tolerant, fail-safe; MCP S4 tools + active-sync build on it)
...
- [domains/application/components/active-table/DOC.md](/docs/domains/application/components/active-table/DOC.md)
