...
Mockable seam over the `bd` (beads) CLI — funnels every bd invocation through one testable function
...
- **part_of**: [mcp-server](../services/mcp-server.md)

## Documentation

- [services/components/bd-seam/DOC.md](/docs/services/components/bd-seam/DOC.md)
