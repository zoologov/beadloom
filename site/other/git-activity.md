...
Git history analysis — per-node commit activity, contributors, and activity classification
...
- [domains/infrastructure/components/git-activity/DOC.md](/docs/domains/infrastructure/components/git-activity/DOC.md)
