...
First-class cross-service contract model + protocol-agnostic reconciliation (contract_key, ContractVerdict)
...
- [domains/graph/components/contracts/DOC.md](/docs/domains/graph/components/contracts/DOC.md)
