...
Canonical catalog of MCP tool names — single source of truth shared by the MCP server and the docs generator
...
- **part_of**: [infrastructure](../domains/infrastructure.md)

## Documentation

- [domains/infrastructure/components/mcp-tools/DOC.md](/docs/domains/infrastructure/components/mcp-tools/DOC.md)
