...
Health metrics — snapshots, trend computation, and the Rich health dashboard
...
- [domains/infrastructure/components/health/DOC.md](/docs/domains/infrastructure/components/health/DOC.md)
