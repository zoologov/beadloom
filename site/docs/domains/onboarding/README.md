...
> ✅ **fresh**
> 
> last synced 2026-06-10T21:18:54.402746+00:00 · coverage 100% (`onboarding`)
> 
...
- `build_protection_payload(*, status_check_contexts=DEFAULT_STATUS_CHECK_CONTEXTS)` -- build the GitHub branch-protection request body (PR required, `beadloom-gate` required under `strict`, `enforce_admins: true` → strict trunk-based even for admins, 0 required reviews, `restrictions: null` → owner NOT locked out, can self-merge once gate is green)
